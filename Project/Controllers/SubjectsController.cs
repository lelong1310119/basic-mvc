...
namespace Project.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public SubjectsController(ManageContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return _context.Subjects != null ? 
                          ...
                          Problem("Entity set 'ManageContext.Subjects'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("SubjectId,SubjectName")] Subject subject)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'ManageContext.Subjects'  is null.");
            }
            var subject = await _context.Subjects.FindAsync(id);
            if (subject != null)
            {
